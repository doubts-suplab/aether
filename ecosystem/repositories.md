...
| `aether-flow` | [suplab/aether-flow](https://github.com/suplab/aether-flow) | Workflow platform — process orchestration, human approval, SLA escalation, Grid DEFER intake | ✅ Phase 1 (orchestration hardening) |
